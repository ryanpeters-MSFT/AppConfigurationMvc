...
## Links
- [Tutorial: Use dynamic configuration in a .NET app](https://docs.azure.cn/en-us/azure-app-configuration/enable-dynamic-configuration-dotnet-core)
- [Tutorial: Use dynamic configuration using push refresh in a .NET app](https://docs.azure.cn/en-us/azure-app-configuration/enable-dynamic-configuration-dotnet-core-push-refresh?tabs=powershell)